...
/**
 * Title: How We Work
 * Slug: saas-consulting-agency/how-we-work
 * Categories: saas-consulting-agency-patterns
 */
$saas_consulting_agency_how_we_work_url = trailingslashit( get_stylesheet_directory_uri() );
$saas_consulting_agency_how_we_work_img = array(
	$saas_consulting_agency_how_we_work_url . 'assets/images/how-we-work.jpg',
	$saas_consulting_agency_how_we_work_url . 'assets/images/how-we-work-icon.png',
	$saas_consulting_agency_how_we_work_url . 'assets/images/star.png',
);
?>
<!-- wp:group {"metadata":{"patternName":"saas-consulting-agency/how-we-work","name":"How We Work","categories":["saas-consulting-agency-patterns"]},"style":{"spacing":{"padding":{"right":"0","left":"0","top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
...
<div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cover {"url":"<?php echo esc_url( $saas_consulting_agency_how_we_work_img[0] ); ?>","id":171,"dimRatio":0,"isUserOverlayColor":true,"minHeight":595,"isDark":false,"sizeSlug":"large","layout":{"type":"constrained"}} -->
<div class="wp-block-cover is-light" style="min-height:595px"><img class="wp-block-cover__image-background wp-image-171 size-large" alt="" src="<?php echo esc_url( $saas_consulting_agency_how_we_work_img[0] ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"placeholder":"Write title…","style":{"typography":{"textAlign":"center"}},"fontSize":"large"} -->
...
<div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color","fontSize":"jumbo"} -->
<h2 class="wp-block-heading has-light-color-color has-text-color has-link-color has-jumbo-font-size">
<?php esc_html_e( 'Advance your business to the next level.', 'saas-consulting-agency' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}}} -->
<p style="margin-top:var(--wp--preset--spacing--50)">
<?php esc_html_e( 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis,', 'saas-consulting-agency' ); ?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( $saas_consulting_agency_how_we_work_img[1] ); ?>" alt="" class="wp-image-181" style="width:auto;height:35px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column {"width":""} -->
<div class="wp-block-column"><!-- wp:heading {"level":5,"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"light-color"} -->
<h5 class="wp-block-heading has-light-color-color has-text-color has-link-color" style="font-style:normal;font-weight:600">
<?php esc_html_e( 'Market Strategy', 'saas-consulting-agency' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|30"}}},"fontSize":"small"} -->
<p class="has-small-font-size" style="margin-top:var(--wp--preset--spacing--30)">
<?php esc_html_e( 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,', 'saas-consulting-agency' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column"><!-- wp:heading {"level":5,"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"light-color"} -->
<h5 class="wp-block-heading has-light-color-color has-text-color has-link-color" style="font-style:normal;font-weight:600">
<?php esc_html_e( 'Financial Strategy', 'saas-consulting-agency' ); ?></h5>
<!-- /wp:heading -->
...
<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--60)"><!-- wp:button {"className":"is-style-button-hover-primary-bgcolor"} -->
<div class="wp-block-button is-style-button-hover-primary-bgcolor"><a class="wp-block-button__link wp-element-button" href="#">
<?php esc_html_e( 'Request Demo', 'saas-consulting-agency' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<?php esc_html_e( '(5.0)', 'saas-consulting-agency' ); ?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( $saas_consulting_agency_how_we_work_img[2] ); ?>" alt="" class="wp-image-213"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<!-- wp:column {"style":{"spacing":{"blockGap":"0","padding":{"right":"var:preset|spacing|50","left":"var:preset|spacing|50","top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}},"border":{"top":{"width":"0px","style":"none"},"right":{"color":"var:preset|color|border-color","width":"1px"},"bottom":{"width":"0px","style":"none"},"left":{"width":"0px","style":"none"}}},"layout":{"type":"constrained","contentSize":"280px"}} -->
...
<h2 class="wp-block-heading">
<?php esc_html_e( '78%', 'saas-consulting-agency' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading">
<?php esc_html_e( '95%', 'saas-consulting-agency' ); ?></h2>
<!-- /wp:heading -->
