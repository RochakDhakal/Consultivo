...
<?php
	esc_html_e( 'Advance your business to the next level.', 'consultivo' );
?>
</h2>
<!-- /wp:heading -->
...
<?php
	esc_html_e( 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis,', 'consultivo' );
?>
</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column" style="flex-basis:35px"><!-- wp:image {"id":181,"width":"35px","aspectRatio":"1","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( $consultivo_how_we_work_img[1] ); ?>" alt="" class="wp-image-181" style="aspect-ratio:1;object-fit:cover;width:35px;height:auto"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<?php
	esc_html_e( 'Market Strategy', 'consultivo' );
?>
</h5>
<!-- /wp:heading -->
...
<h5 class="wp-block-heading has-light-color-color has-text-color has-link-color" style="font-style:normal;font-weight:600">
<?php
	esc_html_e( 'Financial Strategy', 'consultivo' );
?>
</h5>
<!-- /wp:heading -->
...
<?php
	esc_html_e( 'Request Demo', 'consultivo' );
?>
</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
