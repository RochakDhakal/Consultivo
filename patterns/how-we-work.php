...
$consultivo_how_we_work_img = array(
	$consultivo_how_we_work_url . 'assets/images/how-we-work.jpg',
	$consultivo_how_we_work_url . 'assets/images/how-we-work-icon.png',
	$consultivo_how_we_work_url . 'assets/images/star.png',
);
?>
...
<div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cover {"url":"<?php echo esc_url( $consultivo_how_we_work_img[0] ); ?>","id":171,"dimRatio":0,"isUserOverlayColor":true,"minHeight":595,"isDark":false,"sizeSlug":"large","layout":{"type":"constrained"}} -->
<div class="wp-block-cover is-light" style="min-height:595px"><img class="wp-block-cover__image-background wp-image-171 size-large" alt="" src="<?php echo esc_url( $consultivo_how_we_work_img[0] ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"placeholder":"Write title…","style":{"typography":{"textAlign":"center"}},"fontSize":"large"} -->
...
<?php esc_html_e( 'Advance your business to the next level.', 'consultivo' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}}} -->
<p style="margin-top:var(--wp--preset--spacing--50)">
<?php esc_html_e( 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis,', 'consultivo' ); ?></p>
<!-- /wp:paragraph -->
...
<?php esc_html_e( 'Market Strategy', 'consultivo' ); ?></h5>
<!-- /wp:heading -->
...
<?php esc_html_e( 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,', 'consultivo' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column"><!-- wp:heading {"level":5,"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"light-color"} -->
<h5 class="wp-block-heading has-light-color-color has-text-color has-link-color" style="font-style:normal;font-weight:600">
<?php esc_html_e( 'Financial Strategy', 'consultivo' ); ?></h5>
<!-- /wp:heading -->
...
<?php esc_html_e( 'Request Demo', 'consultivo' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<?php esc_html_e( '(5.0)', 'consultivo' ); ?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( $consultivo_how_we_work_img[2] ); ?>" alt="" class="wp-image-213"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading">
<?php esc_html_e( '78%', 'consultivo' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading">
<?php esc_html_e( '95%', 'consultivo' ); ?></h2>
<!-- /wp:heading -->
