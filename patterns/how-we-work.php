...
<h2 class="wp-block-heading has-light-color-color has-text-color has-link-color has-jumbo-font-size">Advance your business to the next level.</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}}} -->
<p style="margin-top:var(--wp--preset--spacing--50)">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis,</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-resized"><img src="http://localhost:8080/wp-content/uploads/2026/08/Mask-group.png" alt="" class="wp-image-181" style="aspect-ratio:1;object-fit:cover;width:35px;height:auto"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<h5 class="wp-block-heading has-light-color-color has-text-color has-link-color" style="font-style:normal;font-weight:600">Market Strategy</h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|30"}}},"fontSize":"small"} -->
<p class="has-small-font-size" style="margin-top:var(--wp--preset--spacing--30)">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:column {"width":""} -->
<div class="wp-block-column"><!-- wp:heading {"level":5,"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"light-color"} -->
<h5 class="wp-block-heading has-light-color-color has-text-color has-link-color" style="font-style:normal;font-weight:600">Financial Strategy</h5>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-button-hover-primary-bgcolor"><a class="wp-block-button__link wp-element-button" href="#">Request Demo</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<figure class="wp-block-image size-full"><img src="http://localhost:8080/wp-content/uploads/2026/08/star-1.png" alt="" class="wp-image-213"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
