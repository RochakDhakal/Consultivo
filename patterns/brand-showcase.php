...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( $consultivo_brand_showcase_img[1] ); ?>" alt="" class="wp-image-113" style="width:auto;height:36px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
