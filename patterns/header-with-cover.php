 ...
 * Slug: consultivo/header-with-cover
 * Categories:  header,consultivo-patterns
 */

	$consultivo_url    = trailingslashit( get_stylesheet_directory_uri() );
	$consultivo_images = array(
		$consultivo_url . 'assets/images/hero-cover.png',
		$consultivo_url . 'assets/images/hero.jpg',
		$consultivo_url . 'assets/images/hero-icon-1.png',
	);
?>
<!-- wp:cover {"url":"<?php echo esc_url( $consultivo_images[0] ); ?>","id":22,"dimRatio":0,"isUserOverlayColor":true,"minHeight":950,"contentPosition":"top center","sizeSlug":"large","metadata":{"patternName":"consultivo/header-with-cover","name":"Header with Hero Section","categories":["header","consultivo-patterns"]},"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"layout":{"type":"constrained","contentSize":"1280px"}} -->
<div class="wp-block-cover has-custom-content-position is-position-top-center" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40);min-height:950px"><img class="wp-block-cover__image-background wp-image-22 size-large" alt="" src="<?php echo esc_url( $consultivo_images[0] ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"right":"0","left":"0","top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"constrained","contentSize":"100%"}} -->
...
<?php
	esc_html_e( 'Start Your Project', 'consultivo' );
?>
</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
...
<li>
<?php
	esc_html_e( 'Digital Studio EST.2026', 'consultivo' );
?>
</li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
...
<?php
	esc_html_e( 'We build digital experiences that drive growth.', 'consultivo' );
?>
</h2>
<!-- /wp:heading -->
...
<p class="has-foreground-color has-text-color has-link-color" style="margin-top:var(--wp--preset--spacing--50)"><?php esc_html_e( 'We help ambitious businesses build high-performing websites, brands, and digital experiences that attract customers and accelerate growth.', 'consultivo' ); ?></p>
<!-- /wp:paragraph -->
...
<?php
	esc_html_e( 'View Demo', 'consultivo' );
?>
</a></div>
<!-- /wp:button -->
...
<h4 class="wp-block-heading has-light-color-color has-text-color has-link-color has-xxx-large-font-size"><?php esc_html_e( '100+', 'consultivo' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"textColor":"foreground","fontSize":"x-small"} -->
<p class="has-foreground-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'Projects delivered', 'consultivo' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
<div class="wp-block-column"><!-- wp:heading {"level":4,"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color","fontSize":"xxx-large"} -->
<h4 class="wp-block-heading has-light-color-color has-text-color has-link-color has-xxx-large-font-size"><?php esc_html_e( '12', 'consultivo' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"textColor":"foreground","fontSize":"x-small"} -->
<p class="has-foreground-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'Design awards', 'consultivo' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
<div class="wp-block-column"><!-- wp:heading {"level":4,"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color","fontSize":"xxx-large"} -->
<h4 class="wp-block-heading has-light-color-color has-text-color has-link-color has-xxx-large-font-size"><?php esc_html_e( '5.0', 'consultivo' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"textColor":"foreground","fontSize":"x-small"} -->
<p class="has-foreground-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'Average Client rating', 'consultivo' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
<div class="wp-block-column"><!-- wp:heading {"level":4,"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color","fontSize":"xxx-large"} -->
<h4 class="wp-block-heading has-light-color-color has-text-color has-link-color has-xxx-large-font-size"><?php esc_html_e( '95%', 'consultivo' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"textColor":"foreground","fontSize":"x-small"} -->
<p class="has-foreground-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'Client Retention', 'consultivo' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( $consultivo_images[2] ); ?>" alt="" class="wp-image-121" style="width:40px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<p class="has-light-color-color has-text-color has-link-color" style="font-style:normal;font-weight:500"><?php esc_html_e( 'Websites Launched', 'consultivo' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"typography":{"fontSize":"9px"}}} -->
<p style="margin-top:0;margin-bottom:0;font-size:9px"><?php esc_html_e( 'Vela Health', 'consultivo' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div></div>
<!-- /wp:cover --></div>
