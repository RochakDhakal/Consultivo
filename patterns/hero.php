...
<?php
	esc_html_e( 'Developing Resilient Leaders, Driving Smarter Growth', 'consultivo' );
?>
</h2>
<!-- /wp:heading -->
...
<?php
	esc_html_e( 'Elegant, user-friendly interface with smooth animations and drag-and-drop functionality.', 'consultivo' );
?>
</p>
<!-- /wp:paragraph -->
