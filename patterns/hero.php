...
/**
 * Title: Hero Section
 * Slug: consultivo/hero
 * Categories: consultivo-patterns
 */
$consultivo_hero_url = trailingslashit( get_stylesheet_directory_uri() );
$consultivo_hero_img = array(
...
<h2 class="wp-block-heading has-light-color-color has-text-color has-link-color has-giga-font-size">Developing Resilient Leaders, Driving Smarter Growth</h2>
<!-- /wp:heading -->
...
<p class="has-light-color-color has-text-color has-link-color" style="margin-top:var(--wp--preset--spacing--50)">Elegant, user-friendly interface with smooth animations and drag-and-drop functionality.</p>
<!-- /wp:paragraph -->
