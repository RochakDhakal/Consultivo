...
$consultivo_images = array(
	$consultivo_url . 'assets/images/team-2.png',
);
?>
...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( $consultivo_images[0] ); ?>" alt="" style="object-fit:cover;width:75px;height:75px"/></figure>
<!-- /wp:image -->
